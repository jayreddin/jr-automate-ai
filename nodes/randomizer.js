export default {
    ...
    category: 'Data & Files',
    color: '#3b82f6',
    inputs: 1,  // Accepts one input
    outputs: 1, // Produces one output
    defaultSettings: {
        inputHandling: 'ignore',  // Default: ignore input
        outputType: 'Number',     // Default output type
        numberMin: 0,             // Number settings
        numberMax: 100,
        numberIsInteger: true,
        stringLength: 10,         // String settings
