/**
 * Text to Speech Node Module
 * Converts text to spoken audio using Puter's AI TTS service
 *
 * @module TextToSpeechNode
 */
export default {
    /**
     * Node Configuration
     ...
     * @type {Object}
     * @property {string} language - Speech language/locale
     * @property {boolean} autoPlay - Whether to play audio automatically
     * @property {string} text - Optional text to convert
     */
    defaultSettings: {
        language: 'en-US',
        autoPlay: true,
    ...
    // Format log messages
    /**
     * Formats log messages for speech operations
     * @param {string} message - The message to format
     * @param {string} type - Message type (info/success)
     * @param {Object} node - Node instance
     * @returns {string} Formatted message with speech details
     */
    ...
    /**
     * Sets up visual feedback for audio processing
     ...
     * @param {Object} node - Node instance
     * @returns {string} HTML content for speech configuration
     */
    createContent: (node) => {
     ...
     * @returns {Promise<Object>} Audio object and metadata
