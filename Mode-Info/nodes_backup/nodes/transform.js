 ...
 * Executes custom JavaScript code to transform input data
 *
...
export default {
     ...
     * @type {Object}
     * @property {string} transformCode - JavaScript code to execute
     * @property {boolean} showPreview - Whether to show result preview
     */
    defaultSettings: {
        transformCode: '',
        showPreview: true
    ...
    // Format log messages
    /**
     * Formats log messages for transform operations
     * @param {string} message - The message to format
     * @param {string} type - Message type (info/success)
     * @param {Object} node - Node instance
     * @returns {string} Formatted message with transformation result
     */
    ...
    /**
     * Sets up visual feedback for code execution
     ...
     * @param {Object} node - Node instance
     * @returns {string} HTML content for transform configuration
     */
    createContent: (node) => {
