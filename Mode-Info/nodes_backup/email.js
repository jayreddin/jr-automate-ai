/**
 * Email Node Module
 * Handles email sending functionality with SMTP and API support
 */
export default {
    /**
     * Node Configuration
    ...
    color: '#38bdf8', // Light blue color for email theme
    inputs: 1,
    outputs: 1,
    ...
    defaultSettings: {
        ...
        body: '', // Email content
        service: 'smtp', // Email service type (smtp/api)
        smtpSettings: {
            host: '', // SMTP server host
            port: 587, // Default SMTP port
            secure: false, // SSL/TLS flag
            user: '', // SMTP username
            password: '' // SMTP password
        },
        useInput: false, // Whether to use input data for email content
        attachFiles: false // Whether to allow file attachments
    },
    ...
    /**
     * Formats log messages for email operations
     ...
     * Sets up email sending animation
     ...
     * Generates email configuration interface with tabs
     ...
     * @param {Object} node - Node instance with email settings
     * @param {*} input - Input data that may contain email content
     * @param {Object} context - Execution context
     * @returns {Promise<Object>} Send result with success status and details
 ...
 * @param {Object} smtpSettings - SMTP server configuration
