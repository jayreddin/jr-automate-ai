/**
 * Prompt Node Module
 * Handles text input and user interaction during flow execution
 *
 * @module PromptNode
 */
export default {
     ...
     * @type {Object}
     * @property {string} content - Predefined text content
     * @property {string} outputMode - How to handle input (replace/append)
     * @property {boolean} askMe - Whether to prompt user during execution
     * @property {string} promptQuestion - Question to show in prompt dialog
     */
    defaultSettings: {
        content: '',
        outputMode: 'replace',
    ...
    // Format log messages
    /**
     * Formats log messages for prompt operations
     * @param {string} message - The message to format
     * @param {string} type - Message type (success/error)
     * @param {Object} node - Node instance
     * @returns {string} Formatted message with prompt details
     */
    ...
    /**
     * Sets up visual indicators for interactive prompts
     ...
     * @param {Object} node - Node instance
     * @returns {string} HTML content for prompt configuration
     */
    createContent: (node) => {
     ...
     * Handles text input and user interaction
     * @param {Object} node - Node instance
     * @param {*} input - Input data to process
     * @param {Object} context - Execution context
     * @returns {Promise<string>} Processed text content
     * @throws {Error} If prompt operation fails
     */
