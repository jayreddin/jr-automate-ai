...
export default {
     ...
     * @type {Object}
     * @property {string} prompt - Image generation prompt
     * @property {string} style - Image style (natural/artistic/photographic)
     * @property {boolean} testMode - Whether to use test mode (no API credits)
     */
    defaultSettings: {
        prompt: '',
        style: 'natural',
    ...
    // Format log messages
    /**
     * Formats log messages for image generation
    ...
    /**
     * Sets up loading animation for image generation
     ...
     * @param {Object} node - Node instance
     * @returns {string} HTML content for image generation configuration
     */
    createContent: (node) => {
    ...
    /**
     * Executes image generation from text
     * @param {Object} node - Node instance
     * @param {string} input - Text prompt input
