/**
 * Loop Node Module
 * Provides various loop operations (count, forEach, while) with safety limits
...
export default {
     ...
     * @type {Object}
     * @property {string} loopType - Type of loop (count/forEach/while)
     * @property {number} count - Number of iterations for count loop
     * @property {string} arrayPath - Path to array for forEach loop
     * @property {string} condition - JavaScript condition for while loop
     * @property {string} currentItemName - Variable name for current item
     * @property {string} indexName - Variable name for current index
     * @property {number} delay - Delay between iterations (ms)
     * @property {number} maxIterations - Safety limit for iterations
     * @property {boolean} collectResults - Whether to collect iteration results
     */
    defaultSettings: {
        loopType: 'count',
        count: 5,
    ...
    /**
     * Formats log messages for loop operations
     * @param {string} message - The message to format
     * @param {string} type - Message type (info/success/error)
     * @param {Object} node - Node instance
     * @returns {string} Formatted message with loop context
     */
    ...
    /**
     * Sets up loop visualization and progress tracking
    ...
    /**
     * Creates the node's UI content with loop configuration options
     * @param {Object} node - Node instance
    ...
    /**
     * Executes the configured loop operation
     * @param {Object} node - Node instance
     * @param {*} input - Input data
     * @param {Object} context - Execution context
     * @returns {Promise<*>} Loop execution result
    ...
    execute: async (node, input, context) => {
        try {
            ...
            /**
             * Executes nodes for each iteration
             * @param {Object} iterationData - Current iteration context
             * @param {number} index - Current iteration index
             * @param {number} total - Total iterations (optional)
             * @returns {Promise<Array>} Results if collection enabled
             */
            ...
            if (loopType === 'count') {
                ...
                /**
                 * Evaluates while loop condition
                 * @param {Object} data - Loop context data
